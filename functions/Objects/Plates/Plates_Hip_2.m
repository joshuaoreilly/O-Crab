classdef Plates_Hip_2
    ...
    methods
        ...
        function obj = Plates_Hip_2(d_knee_shaft,D_hip_shaft,shaft_hipKnee,max_diameter_pulley,leg_r1,distance_between_shafts,adapter_Knee,key_Hip_Plates,spring_Torsion_Hip,spring_Torsion_Knee)
